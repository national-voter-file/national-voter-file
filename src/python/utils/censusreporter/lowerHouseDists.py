...
cd = pd.read_csv("C:/dev/GitHub/getmovement/national-voter-file/data/NewYork/StateAssembly.txt")
...
data.to_csv("C:/dev/GitHub/getmovement/national-voter-file/data/NewYork/StateAssembly_OUT.txt")
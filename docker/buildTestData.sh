...
###################
## Run job to process test voter file
docker-compose run etl /opt/pentaho/data-integration/kitchen.sh -file /national-voter-file/src/main/pdi/washington/ProcessWashingtonFile.kjb -param:reportDate=2016-05-30 -param:reportFile=/national-voter-file/testdata/Washington/Washington\ State\ Data.txt -param:reporterKey=1

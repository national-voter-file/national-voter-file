...
if "%PENTAHO_DI_JAVA_OPTIONS%"=="" set PENTAHO_DI_JAVA_OPTIONS="-Xms128m" "-Xmx512m" "-XX:MaxPermSize=256m"
...
@echo on
%SPOON_START_OPTION% "%_PENTAHO_JAVA%" %OPT% -jar launcher\pentaho-application-launcher-6.1.0.1-196.jar -lib ..\%LIBSPATH% %_cmdline%
@echo off
